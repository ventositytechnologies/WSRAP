...
<input type="text" name="cname" placeholder="Enter Customer Name" style="width: 268px;" >
<br><br>
<input type="text" name="mob" placeholder="Enter Customer Mobile No:" style="width: 268px;" >
<br><br>
<input type="text" name="dname" placeholder="Enter Doctor Name" style="width: 268px;" >
