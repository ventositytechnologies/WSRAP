...
<body>
  ...
  <a class="go-back-link" href="sales.php"><i class="fa fa-arrow-left"></i></a><a style="padding:60px; font-size:20px;"> Customer Follow Up </a>
</div>
               ...
               <!--      <?php include 'addproduct.php'; ?> -->
				...
				<th> Project Name  </th>
                        ...
                        <tbody>
                            ...
                            $result = $db->prepare("SELECT * FROM products WHERE fdate = '$small' ");
